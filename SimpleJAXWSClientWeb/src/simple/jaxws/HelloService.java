...
@WebServiceClient(name = "HelloService", targetNamespace = "http://jaxws.simple/", wsdlLocation = "WEB-INF/wsdl/HelloService.wsdl")
    ...
    extends Service
{
    ...
    static {
            HELLOSERVICE_WSDL_LOCATION = simple.jaxws.HelloService.class.getResource("/WEB-INF/wsdl/HelloService.wsdl");
