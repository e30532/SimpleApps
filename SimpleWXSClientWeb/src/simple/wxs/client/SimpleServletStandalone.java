...
/**
 * Servlet implementation class SimpleServletStandalone
 */
@WebServlet("/SimpleServletStandalone")
public class SimpleServletStandalone extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SimpleServletStandalone() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String catalogServiceEndpoints = "fyre11:4809,fyre11:4810";
		try {
