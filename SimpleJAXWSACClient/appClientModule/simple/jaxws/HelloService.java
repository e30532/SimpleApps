...
@WebServiceClient(name = "HelloService", targetNamespace = "http://jaxws.simple/", wsdlLocation = "META-INF/wsdl/HelloService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://jaxws.simple/", "HelloService");

    static {
            HELLOSERVICE_WSDL_LOCATION = simple.jaxws.HelloService.class.getClassLoader().getResource("/META-INF/wsdl/HelloService.wsdl");
        WebServiceException e = null;
        if (HELLOSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/HelloService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://jaxws.simple/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.simple/", "HelloPort"), Hello.class, features);
    }
