...
@WebServiceClient(name = "HelloService", targetNamespace = "http://wsat.simple/", wsdlLocation = "WEB-INF/wsdl/HelloService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://wsat.simple/", "HelloService");

    static {
            HELLOSERVICE_WSDL_LOCATION = simple.wsat.HelloService.class.getResource("/WEB-INF/wsdl/HelloService.wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://wsat.simple/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsat.simple/", "HelloPort"), Hello.class, features);
    }
