 ...
 * generated in the simple.wsat package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://wsat.simple/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://wsat.simple/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: simple.wsat
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsat.simple/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsat.simple/", name = "sayResponse")
